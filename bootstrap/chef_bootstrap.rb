...
mkdir /etc/chef
wget https://s3.amazonaws.com/verdeeco.bootstrap/client.rb -O /etc/chef/client.rb
wget https://s3.amazonaws.com/verdeeco.bootstrap/validation.pem -O /etc/chef/validation.pem
